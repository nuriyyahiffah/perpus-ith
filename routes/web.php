...
Route::middleware(['auth'])->group(function () {
    ...
    */
    Route::middleware(['checkRole:admin,pustakawan'])->prefix('kelola')->name('shared.')->group(function() {         
        ...
        Route::controller(PeminjamanController::class)->group(function() {
            ...
            Route::get('/api/books-search', 'getBooks')->name('getBooks');
            Route::get('/get-eksemplar/{buku_id}', 'getEksemplar')->name('getEksemplar');
        });
        ...
        // --- MANAJEMEN USULAN BUKU (Sinkron dengan Blade Admin) ---
        Route::get('/usulan-buku', [UsulanController::class, 'index'])->name('usulan.index');
        Route::patch('/usulan-buku/konfirmasi/{id}', [UsulanController::class, 'updateStatus'])->name('usulan.konfirmasi');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::middleware(['checkRole:dosen'])->prefix('dosen')->name('dosen.')->group(function () {
