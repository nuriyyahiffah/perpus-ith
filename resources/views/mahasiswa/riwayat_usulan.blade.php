        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="text-center py-20 bg-white rounded-[3rem] border-2 border-dashed border-slate-200">
                    ...
                    <a href="{{ route('mahasiswa.usulan.create') }}" class="mt-4 inline-block text-[10px] font-black text-blue-600 uppercase border-b-2 border-blue-600 pb-1 hover:text-blue-800 transition">Ajukan Usulan Sekarang</a>
                </div>
                @endforelse
            </div>
        </div>
