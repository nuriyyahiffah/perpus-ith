...
<body class="antialiased">
    ...
    {{-- NAVBAR --}}
    <nav class="glass-nav sticky top-0 z-50 border-b border-white/10 text-white py-4 shadow-xl">
        ...
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center justify-center">
                    <img src="{{ asset('images/logo_ith.png') }}"
                        alt="Logo ITH"
                ...
                <div class="leading-none border-l border-white/10 pl-4">
                    ...
                    <span class="font-black italic uppercase tracking-tighter text-xl block">
                        SIPUSTAKA
                    </span>

                    <span class="text-[8px] font-bold text-slate-400 uppercase tracking-[0.2em]">
            ...
            <div class="flex items-center gap-6">
                ...
                @auth
                    ...
                    <div class="hidden md:flex flex-col items-end leading-none">
                        ...
                        <span class="text-[9px] font-black uppercase text-slate-400 tracking-widest mb-1">
                            Pengguna aktif
                        </span>

                        <span class="text-xs font-bold text-yellow-400 italic">
                            {{ Auth::user()->name }}
                        </span>
                    ...
                    <a href="{{ route($dashRoute) }}"
                        class="bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all border border-white/10 active:scale-95">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}"
                        class="bg-[#10B981] hover:bg-[#059669] text-white px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition shadow-lg shadow-emerald-500/20 active:scale-95">
    ...
    <main class="max-w-7xl mx-auto px-6 pb-20">
        ...
        <form action="{{ route('katalog.index') }}"
            ...
            <div class="flex flex-col md:flex-row gap-3">
                ...
                <select
                    name="sort"
                    class="px-6 py-4 bg-white/80 backdrop-blur border border-slate-200 rounded-2xl text-[11px] font-black uppercase tracking-wider text-slate-600 outline-none cursor-pointer shadow-sm appearance-none">
                    ...
                    <option value="a-z"
                        {{ request('sort') == 'a-z' ? 'selected' : '' }}>
                        Judul A - Z
                    </option>

                    <option value="z-a"
                        {{ request('sort') == 'z-a' ? 'selected' : '' }}>
                        Judul Z - A
                    </option>
                ...
                <div class="bg-white/80 backdrop-blur p-4 rounded-[2rem] border border-white shadow-sm card-hover transition-all duration-300 group">
                    ...
                    <div class="aspect-[3/4] bg-slate-100 rounded-2xl mb-4 overflow-hidden flex items-center justify-center relative border border-slate-100">
                        ...
                        @elseif($item->gambar_buku)
                            ...
                            <img src="{{ asset('images/' . $item->gambar_buku) }}"
                                class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                    ...
                    <div class="px-1">
                        ...
                        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-tighter truncate mb-5">
                            ...
                            <span class="text-indigo-600 mr-1 italic font-medium">
                                By
                            </span>
