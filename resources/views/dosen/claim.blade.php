        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div class="inline-flex bg-slate-200/50 p-1 rounded-2xl shadow-inner border border-slate-200">
                    <a href="?tab=semua" class="px-6 py-2 text-[10px] font-black uppercase rounded-xl transition-all {{ $tab == 'semua' ? 'bg-white text-blue-600 shadow-sm' : 'text-slate-500 hover:text-slate-700' }}">Judul</a>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden transition-all duration-300">
                <table class="w-full text-left border-collapse">
                    <thead class="bg-slate-50/50 border-b border-slate-100">
                        <tr>
                            <th class="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Judul & Detail Buku</th>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-blue-50/30 transition-colors group">
                            ...
                            <td class="px-8 py-6 text-center text-center">
