...
<body class="antialiased" x-data="{ profileOpen: false }">
    ...
    <nav class="bg-[#1E293B]/90 backdrop-blur-md text-white py-4 sticky top-0 z-50 border-b border-white/10">
        <div class="container mx-auto flex justify-between items-center px-6">
            ...
            <div class="flex items-center gap-4">
               ...
               <div class="relative">
    <a href="{{ route('notifikasi.index') }}" class="relative inline-flex items-center p-2 text-white/70 hover:text-yellow-400 transition-all">
        <i class="bi bi-bell text-xl"></i>

        {{-- TEMPATKAN DI SINI --}}
        @php
            // Membungkus variabel agar tidak error jika data kosong (null)
            $riwayatPinjamCollection = collect($riwayatPinjam ?? []);
            
            // Menghitung buku yang statusnya masih 'Dipinjam' tapi sudah melewati tanggal kembali
        ...
        {{-- Menampilkan angka badge jika ada keterlambatan --}}
        @if($lateCount > 0)
        ...
        @endif
                ...
                <div class="relative">
                    ...
                    <div x-show="profileOpen"
                         ...
                         class="absolute right-0 mt-3 w-64 bg-white rounded-3xl shadow-2xl border border-slate-100 py-4 z-[60] text-slate-700">
                        ...
                        {{-- Menu: Riwayat Usulan --}}
                        <a href="{{ route('dosen.usulan.riwayat') }}" class="flex items-center gap-4 px-6 py-3 hover:bg-slate-50 hover:text-blue-600 transition-all group">
    ...
    <main class="container mx-auto -mt-10 px-6 pb-20 relative z-20 space-y-20">
        ...
        {{-- SECTION: BUKU TERBARU (GAYA DARK CARD) --}}
        <section>
...
<section class="mt-20">
                        ...
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-5">
                                <div class="h-16 w-12 bg-slate-200 rounded-xl overflow-hidden shadow-md group-hover:scale-110 transition-transform duration-300">
                                    <img src="{{ $pinjam->buku->gambar_buku ? asset('images/'.$pinjam->buku->gambar_buku) : asset('images/default-cover.jpg') }}" 
    ...
    <footer class="py-12 bg-white border-t border-slate-100">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-[8px] text-slate-400 font-bold uppercase italic">Institut Teknologi Bacharuddin Jusuf Habibie (ITH)</p>
        </div>
    </footer>
